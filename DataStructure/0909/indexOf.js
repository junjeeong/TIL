...
//indexOf(value) : value값을 data로 갖는 node의 index를 출력하는 함수
LinkedList.prototype.indexOf = function (value) {
    ...
    if (value == null){
        console.log(`value가 비었습니다.`);
        return; //예외처리 할때는 끝에 항상 return
    }
    if (current.data == value){
        console.log(`value는 1번째에 있습니다.`);
        return;
    }
    ...
    if(current === null){
        console.log('value를 찾지 못하였습니다.ㅜ0ㅜ');
    } else {
    console.log(`value는 ${index+1}번째에 있습니다.`);
    }
}
//////* Test Code *//////
